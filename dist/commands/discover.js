...
async function discoverCommand() {
    ...
    devices.forEach((device, i) => {
        ...
        console.log(`     Name : ${chalk_1.default.cyan(device.hostname)}`);
    ...
    if (devices.length === 1) {
        ...
        const { index } = await (0, prompts_1.default)({
            ...
            choices: devices.map((d, i) => ({
                title: `${d.ip}  ${chalk_1.default.dim(d.hostname)}  ${d.verified ? chalk_1.default.green('✔ SSH') : chalk_1.default.yellow('⚠ unverified')}`,
                value: i,
            })),
        });
        if (index === undefined) {
